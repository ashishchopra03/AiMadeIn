...
try {
	...
	header("location:./");	
		...
		foreach($result as $row)
		{
			...
			$myfname = "Anonymous"; // Replace with a generic term
			$mylname = ""; // Do not display last name
			$bdate = $row['bdate']; // Consider if you want to show this
			$bmonth = $row['bmonth']; // Consider if you want to show this
			$byear = $row['byear']; // Consider if you want to show this
			$mycountry = "Country Hidden"; // Replace with a generic term
			$mycity = "City Hidden"; // Replace with a generic term
			$myphone = "Phone Hidden"; // Do not display phone number
			$about = "Profile information is anonymous."; // Generic description
			$empavatar = $row['avatar']; // You may choose to show a default avatar
			$current_year = date('Y');
			$myage = $current_year - (int)$byear; // You may choose to hide age as well
			$myedu = "Education Hidden"; // Replace with a generic term
			$mytitle = "Title Hidden"; // Replace with a generic term
			$mymail = "Email Hidden"; // Do not display email
		}
	}
...
<head>
	...
	<title>AiMadeIN - <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About AiMadeIn</h5>
											<p>In a continent as diverse and dynamic as Africa, finding the right job can be both exciting and challenging. Aimadein is here to bridge the gap between job seekers and employers across the African continent. Our platform is designed to cater to the unique needs of job seekers and employers in various African countries, providing a seamless and efficient job search experience.</p>
