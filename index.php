...
<head>
	...
	<title>AiMadeIn - Job Portal</title>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<p>Finding your next job or career on AiMadeIn</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">AiMadeIn Contact</h5>
								
								<p>Address : Nairobi, Nairobi 00100, KE </p>
								<p>Email : <a href="mailto:hello@aimadein.africa">hello@aimadein.africa </a></p>
								<p>Phone : <a href="tel:+254719501393">+254719501393</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> AiMadeIn Vision Software</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Kennedy Kwambai, Michael Opondo</a></li>
								</ul>
